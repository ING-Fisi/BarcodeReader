...
QCheckBoxCustom::QCheckBoxCustom(const QString &text) :
    QCheckBox(text)
{
...
class DatePickerPopupPrivate {
    ...
    void initUi()
    {
        ...
        tableweek = new QTableWidget(7, 3, q);

        days[0] = new QCheckBoxCustom("LUNEDI");
        days[1] = new QCheckBoxCustom("MARTEDI");
        days[2] = new QCheckBoxCustom("MERCOLEDI");
        days[3] = new QCheckBoxCustom("GIOVEDI");
        days[4] = new QCheckBoxCustom("VENERDI");
        days[5] = new QCheckBoxCustom("SABATO");
        days[6] = new QCheckBoxCustom("DOMENICA");


        tableweek->setCellWidget(0,0,days[0]);
        tableweek->setCellWidget(1,0,days[1]);
        tableweek->setCellWidget(2,0,days[2]);
        tableweek->setCellWidget(3,0,days[3]);
        tableweek->setCellWidget(4,0,days[4]);
        tableweek->setCellWidget(5,0,days[5]);
        tableweek->setCellWidget(6,0,days[6]);
...
void DatePickerPopup::setDatePickerType(DatePickerType picker_type)
{
    ...
    d->calendar_widget_1->setVisible(false);
    d->calendar_widget_2->setVisible(false);
    d->calendar_widget_1->setFrameVisible(false);
    d->calendar_widget_2->setFrameVisible(false);
    d->time_edit_1->setVisible(false);
    d->time_edit_2->setVisible(false);
    ...
    case DayType:
        ...
        d->time_edit_1->setVisible(true);
        d->time_edit_2->setVisible(true);
    ...
    case PeriodType:
        ...
        d->calendar_widget_2->setVisible(true);
        d->calendar_widget_1->setFrameVisible(true);
        d->calendar_widget_2->setFrameVisible(true);
        d->calendar_widget_2->setEnabled(true);
...
void DatePickerPopup::setTimeEditable(bool on)
{
    ...
    bool show_time_input = (d->is_time_editable && ((d->footer->pickerType() == PeriodType)||(d->footer->pickerType() == DaysType)));
