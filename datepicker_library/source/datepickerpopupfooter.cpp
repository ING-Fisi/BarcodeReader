...
class DatePickerPopupFooterPrivate {
    ...
    QRadioButton *days_picker_type_radio_button;
    QRadioButton *period_picker_type_radio_button;

    DatePickerPopupFooterPrivate(DatePickerPopupFooter *q) :
        q_ptr(q), allowed_picker_types(DayType | DaysType | PeriodType) {}
    ...
    void initUi()
    {
        ...
        days_picker_type_radio_button = new QRadioButton(QObject::tr("days"), q);
        ...
        picker_type_button_group->addButton(days_picker_type_radio_button);
        ...
        buttons_layout->addWidget(days_picker_type_radio_button);
...
DatePickerType DatePickerPopupFooter::pickerType() const
{
    ...
    else if (d->days_picker_type_radio_button->isChecked())
        return DaysType;
...
void DatePickerPopupFooter::setPickerType(DatePickerType picker_type)
{
    ...
    if (pickerType() != picker_type) {
        ...
        d->days_picker_type_radio_button->setChecked(picker_type == DaysType);
...
void DatePickerPopupFooter::setAllowedPickerTypes(DatePickerTypes picker_types)
{
    ...
    d->days_picker_type_radio_button->setVisible(picker_types & DaysType);
    ...
    else if (d->days_picker_type_radio_button->isVisible())
        d->days_picker_type_radio_button->setChecked(true);
    else
