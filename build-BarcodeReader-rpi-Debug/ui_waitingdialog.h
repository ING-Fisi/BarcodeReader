...
public:
    ...
    void retranslateUi(QDialog *WaitingDialog)
    {
        ...
        label->setText(QCoreApplication::translate("WaitingDialog", "STO CONFIGURANDO IL SISTEMA", nullptr));
        label_2->setText(QCoreApplication::translate("WaitingDialog", "ATTENDERE PREGO", nullptr));
        label_gif->setText(QCoreApplication::translate("WaitingDialog", "TextLabel", nullptr));
    } // retranslateUi
