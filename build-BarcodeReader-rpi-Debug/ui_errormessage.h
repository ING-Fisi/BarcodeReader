...
public:
    ...
    void retranslateUi(QDialog *ErrorMessage)
    {
        ...
        label_2->setText(QCoreApplication::translate("ErrorMessage", "PER LA CONFIGURAZIONE", nullptr));
        label->setText(QCoreApplication::translate("ErrorMessage", "QR CODE NON VALIDO", nullptr));
    } // retranslateUi
